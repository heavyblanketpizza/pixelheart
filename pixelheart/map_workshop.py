...
class MapWorkshop(QDialog):
    ...
    def __init__(self, project_file, parent=None):
        ...
        right_layout.addWidget(label("The preview shows your painted layers. Doors, entry points, routes, and walkability still need a game test. Configure the entrance in Home → Room settings after saving.", "muted", True))
